    ...
    <aside class="sidebar">
      <div>
        ...
        <ul class="sidebar-nav nav flex-column">
          ...
          <li class="nav-item">
            <a href="./pos.php" class="nav-link active"><i class="fas fa-cart-shopping me-2"></i>Pos</a>
          </li>
          <li class="nav-item">
      ...
      scanner.addListener('scan', function(qrContent) {
        ...
        $.ajax({
          ...
          success: function(htmlData) {
            ...
            $('.qr-scanner').html('<div class="d-flex align-items-center justify-content-center" height="400px"><h4>Scan acquired...</h4></div>');
          }
