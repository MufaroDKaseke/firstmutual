          ...
          <div class="row">
            ...
            <div class="col-9">
              <section class="welcome">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam a harum facere sint blanditiis cupiditate?</p>
                <a href="<?=$_ENV['ROOT'];?>dashboard/staff/pos.php" class="btn btn-primary">Open POS</a>
              </section>
            </div>
            <div class="col-3">
              <section class="total-sales text-center">
                <h2>Today Sales</h2>
